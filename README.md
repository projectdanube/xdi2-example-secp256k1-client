...
Example XDI client using **cid-2** cryptographic XDI numbers.

### Information

See [xdi2-crypto-secp256k1](https://github.com/projectdanube/xdi2-crypto-secp256k1) for more information.
